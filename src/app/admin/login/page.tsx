        ...
        <div className="bg-white rounded-xl p-6 sm:p-8 shadow-lg border border-gray-100">
          ...
          <div className="text-center mb-6">
            <div className="inline-flex items-center justify-center w-12 h-12 bg-green-100 rounded-xl mb-3">
              <i className="fas fa-user-shield text-green-600 text-lg"></i>
            </div>
            <h2 className="text-xl font-bold text-gray-900">Acesso Interno</h2>
            <p className="text-gray-500 text-sm mt-1">Entre com suas credenciais de funcionário</p>
          </div>
          ...
          <div className="space-y-3">
            <Link
              href="/"
              className="w-full flex items-center justify-center gap-2 py-2.5 px-4 border border-gray-300 text-gray-700 text-sm font-medium rounded-lg hover:bg-gray-100 transition-colors"
            >
